...
public class InsertData extends JFrame{
	...
	private JComboBox jc_assig, jc_tech;
	private JButton button1, button2, button3, button_pop1, button_pop2;
	...
	public InsertData() {	    
	    ...
	    jc_assig = new JComboBox(new String[]{"", "101", "102", "103", "104", "105"});

		// create technician number required
		lb_tech = new JLabel("Technician Number Required ");
		jc_tech = new JComboBox(new String[]{"", "1", "2", "3", "4", "5"});
		...
		ItemListener itemListener1 = new ItemListener() {
		      public void itemStateChanged(ItemEvent itemEvent) {
		        ...
		        assig = selectedString(is);
		        System.out.println(", Selected: " + selectedString(is));
		      }
		    };
		    jc_assig.addItemListener(itemListener1);
			...
			ItemListener itemListener2 = new ItemListener() {
			      public void itemStateChanged(ItemEvent itemEvent) {
			        ...
			        System.out.println("Item: " + itemEvent.getItem());
			        ItemSelectable is = itemEvent.getItemSelectable();
			        tech = selectedString(is);
			        System.out.println(", Selected: " + selectedString(is));
			      }
			    };
		    jc_tech.addItemListener(itemListener2);
		...
		this.setTitle("Help Desk Trouble Ticket");
	  ...
	  public class event implements ActionListener {
			public void actionPerformed(ActionEvent e) {
				try	{
					...
					assignee = Integer.parseInt(assig);
					tech_required = Integer.parseInt(tech);
				...
				JOptionPane.showMessageDialog(null, "Warn: not null allowed!");
				}
			}
		}
