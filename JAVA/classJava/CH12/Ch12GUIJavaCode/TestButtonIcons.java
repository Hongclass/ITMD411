...
public class TestButtonIcons extends JFrame  {
  ...
  public TestButtonIcons() {
	ImageIcon usIcon = new ImageIcon(getClass().getResource("image/usIcon.gif"));
	ImageIcon caIcon = new ImageIcon(getClass().getResource("image/caIcon.gif"));
	ImageIcon ukIcon = new ImageIcon(getClass().getResource("image/ukIcon.gif"));
