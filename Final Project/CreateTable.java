...
public class CreateTable {
	...
	public void createDataBase() throws Exception {
		try {
			...
			sql = "CREATE TABLE Bkan_Hzhan_tickets "
			...
			sql = " ALTER TABLE Bkan_Hzhan_tickets ADD CONSTRAINT fk_2 FOREIGN KEY (Assignee) REFERENCES Bkan_Hzhan_employees(employee_id);";
			statement.executeUpdate(sql);
	...
	public void insertIntoDataBase() throws Exception {
		try {
			...
			statement.executeUpdate(sql);
			sql = "INSERT INTO Bkan_Hzhan_employees(employee_id, first_name, last_name, email, phone_number, department_id, location) " + "VALUES (101, 'Bill', 'Black', 'gob@gmail.com', '312-933-4097', 20, 'IT');";
			statement.executeUpdate(sql);
